        ...
        <div className="flex flex-col">
            ...
            <div className="text-muted-foreground flex flex-col gap-2">
                ...
                <div className="flex gap-2 mt-4">
                    <Link
                        href="https://github.com/magnuspladsen"
                        target="_blank"
                    ...
                    >
                        <div className='flex items-center gap-2 bg-[#24292e] text-white px-3 py-1.5 rounded-md w-fit hover:bg-[#24292e]/90 transition-all shadow-md shadow-primary/10 hover:scale-105 duration-150'>
                            ...
                            <p className='text-sm'>Magnus Pladsen</p>
                        </div>
                    </Link>
                    <Link
                        href="https://www.linkedin.com/in/magnus-pladsen"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <div className='flex items-center gap-2 bg-[#0077b5] text-white px-3 py-1.5 rounded-md w-fit hover:bg-[#0077b5]/90 transition-all shadow-md shadow-primary/10 hover:scale-105 duration-150'>
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
